...
public class Mario : MonoBehaviour
{
    ...
    public void ApplyStateChange(EMarioState newState)
    {
        ...
        if (marioState.Form == EMarioForm.Super)
        {
            ...
            {
                ApplySmallColliderSide();
            }
            else if (oldState == EMarioState.Ducking)
            {
                ApplySuperColliderSide();
            }
        }
    ...
    public void ApplyTransformChange(EMarioForm newForm, bool noAnimation = false)
    {
        ...
        // Set the collider size based on the form
        if (marioState.Form == EMarioForm.Super)
        {
            ApplySuperColliderSide();
        }
    ...
    {
        return marioState.IsRunning && marioState.RunningMeter == settings.MaxRunningMeter;
    }
    ...
    private void ApplySmallColliderSide()
    {
    ...
    private void ApplySuperColliderSide()
    {
        // Update the collider's size and offset

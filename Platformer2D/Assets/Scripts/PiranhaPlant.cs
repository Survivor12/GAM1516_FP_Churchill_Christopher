    ...
    private void SetState(EPiranhaPlantState newState)
    {
        if (state != newState)
        {
            ...
            if (state == EPiranhaPlantState.Hiding)
            {
                ...
                holdTimer = UnityEngine.Random.Range(settings.PiranhaPlantHiddenDurationMin, settings.PiranhaPlantHiddenDurationMax);
            }
            else if (state == EPiranhaPlantState.AnimatingUp)
            {
            ...
            else if (state == EPiranhaPlantState.Active)
            {
                ...
                holdTimer = settings.PiranhaPlantActiveDuration;
            }
            else if (state == EPiranhaPlantState.AnimatingDown)
            {
                animationTimer = settings.PiranhaPlantAnimationDuration;
